    ...
    return (
        <div className="container">
            <div className="top flex gap-8 ">
                <div className="info  flex  flex-1 flex-col justify-between">
                    <h1 className="title text-3xl">
                        {data.title}
                    </h1>
                    <p className="desc text-[18px]">
                        {data.body}
                    </p>

                    <div className="author flex gap-5 items-center">
                            <Image className="avatar"
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmN8Jsw7h4I2z_dx2i2483ByfJQ8PRnhWFo30_EPwbog&s"
                            alt=""
                            width={40}
                            height={40}
                            />
                    ...
                    <div className="imgContainer flex-1 relative h-[500px]  ">
            ...
            <div className="context">
                <p className="text text-[18px] mt-[50px] text-justify">
